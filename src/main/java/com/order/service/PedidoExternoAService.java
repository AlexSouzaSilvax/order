...
public class PedidoExternoAService {
    ...
    /**
     * Obtém os pedidos da API externa. A requisição é feita utilizando o RestTemplate.
     * A resposta da API é convertida para uma lista de objetos {@link PedidoExternoA}.
     *
     * @return Uma lista de objetos {@link PedidoExternoA}.
     *         Retorna uma lista vazia caso a API não retorne resultados ou em caso de falha na requisição.
     */
     ...
     * Esse método converte os dados recebidos da API externa para o formato adequado e os envia para o serviço 
     * {@link PedidoService} para processamento e armazenamento no banco de dados.
     */
    public void importarPedidosExternoA() {
        pedidoService.processarPedidosExternos(obterPedidosExternos());
    }
}
